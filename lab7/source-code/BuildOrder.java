...
public class BuildOrder {
    ...
    public static Component getOrder()
    {
        ...
        String[] sauceOptions1 = { "Mayonnaise", "Thai Peanut Sauce" } ;
        sauce1.setOptions( sauceOptions1 ) ;
        ...
        String[] premiumToppingOptions1 = { "Marinated Tomatoes" } ;
        premiumToppings1.setOptions( premiumToppingOptions1 ) ;
